      ...
      <div class="container">
        <div class="privacy-policy__layout">
          <div class="privacy-policy__container">
            <section class="privacy-policy__section__content">
              <span class="privacy-policy__section__title">Some title here</span>
              <p class="privacy-policy__section__paragraph">
                ...
                elementum
                lacus. Cras mauris mi, vulputate ac justo vitae, fringilla vestibulum sapien. Sed hendrerit nulla id
                luctus placerat. Sed venenatis ornare augue, et viverra dolor ullamcorper id. Duis id quam hendrerit,
                mollis ex ut, varius ipsum.
              </p>
              <p class="privacy-policy__section__paragraph">
                ...
                ligula,
                aliquam ullamcorper enim ultricies sit amet. In placerat sapien eu ligula commodo pharetra. Nunc et
                facilisis dolor, ut condimentum metus. Phasellus lacinia efficitur diam sed pharetra. Nullam euismod
                magna
                at mauris hendrerit scelerisque vitae vel leo. Cras interdum tellus in sapien fermentum consequat.
              </p>
              <p class="privacy-policy__section__paragraph">
                Sed sollicitudin non elit eu faucibus. Phasellus et enim ultricies, tincidunt velit eu, dictum dui.
                Proin
                laoreet semper sapien vitae aliquet. Vestibulum accumsan nibh pharetra dui vulputate commodo.
                Pellentesque
                a justo eu diam cursus auctor. Quisque sit amet maximus lacus, in mollis nunc. Lorem ipsum dolor sit
                amet,
