...
public class AuctionTimeSpanValidator implements Validator<ItemTimeSpan> {
    ...
    private static void ensureDifferentDateTime(final ZonedDateTime startTime, final ZonedDateTime endTime) {
    ...
    private static void ensureStartTimeBeforeEndTime(final ZonedDateTime startTime, final ZonedDateTime endTime) {
        if (startTime.isAfter(endTime)) {
            throw new ValidationException("Ensure that the start date of the item precedes the specified end date.");
        }
    }

    private static void validateTimeSpan(final ZonedDateTime startTime, final ZonedDateTime endTime) {
    ...
    private static boolean isSameDate(final ZonedDateTime startTime, final ZonedDateTime endTime) {
